class WatchesController < ApplicationController
  ...
  private
    ...
    def watch_params
      params.require(:watch).permit(:brand, :movement, :reference, :case_material, :year, :case_diameter, :case_height, :lug_width, :description, :retail_price, :url, :collection, :dial_color, :strap, :buckle, :numerals, :water_resistance, :glass)
    end
end
